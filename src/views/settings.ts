...
export const settingsMarkup = `
  <section id="settings" class="app-view" aria-labelledby="settings-title" hidden>
    ...
    <div class="settings-panel direction-setting">
      <label for="both-directions">Test cards in both directions</label>
      <input id="both-directions" type="checkbox" aria-describedby="direction-status">
      <p id="direction-status" role="status"></p>
    </div>
    ...
    <section class="settings-panel about" aria-labelledby="about-title">
      ...
      <p>Try to remember the answer before revealing it. Retrieving a word from memory helps strengthen your recall. Then choose “Again” or “Good” to tell the app how you did.</p>
